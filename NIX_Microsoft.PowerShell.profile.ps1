...
/opt/ssis - SQL Server Integration Services
/opt/vmw-vddk - VMware Virtual Disk Development Kit binaries #>

$Env:PATH += ":$HOME/Applications/bin:$HOME/.cabal/bin:$HOME/.cargo/bin:/opt/mssql-tools/bin:/opt/ssis/bin:/opt/vmware-vddk/bin64"
